                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="message">
                                    <div class="message-list-container">
                                        ...
                                        <ul class="clearfix">
                                            <li class="clearfix">
                                                <a href="#" class="message-thumb"><img src="/ui/images/avatar/robertoortiz.jpg" alt="image">
                                            ...
                                            <li class="clearfix">
                                                <a href="#" class="message-thumb"><img src="/ui/images/avatar/michael-owens.jpg" alt="image">
                                            ...
                                            <li class="clearfix">
                                                <a href="#" class="message-thumb"><img src="/ui/images/avatar/bobbyjkane.jpg" alt="image">
                                            ...
                                            <li class="clearfix">
                                                <a href="#" class="message-thumb"><img src="/ui/images/avatar/coreyweb.jpg" alt="image">
